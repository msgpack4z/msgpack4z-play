...
```scala
libraryDependencies += "com.github.xuwei-k" %% "msgpack4z-play" % "0.5.0-M4"
```
...
- [sxr](https://oss.sonatype.org/service/local/repositories/releases/archive/com/github/xuwei-k/msgpack4z-play_2.11/0.5.0-M4/msgpack4z-play_2.11-0.5.0-M4-sxr.jar/!/index.html)
