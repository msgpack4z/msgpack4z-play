...
```scala
libraryDependencies += "com.github.xuwei-k" %% "msgpack4z-play" % "0.5.3"
```
...
- [sxr](https://oss.sonatype.org/service/local/repositories/releases/archive/com/github/xuwei-k/msgpack4z-play_2.11/0.5.3/msgpack4z-play_2.11-0.5.3-sxr.jar/!/index.html)

### snapshot version (play-json 2.6.x)

```scala
libraryDependencies += "com.github.xuwei-k" %% "msgpack4z-play" % "0.5.4-SNAPSHOT"
...
- [sxr](https://oss.sonatype.org/service/local/repositories/snapshots/archive/com/github/xuwei-k/msgpack4z-play_2.11/0.5.4-SNAPSHOT/msgpack4z-play_2.11-0.5.4-SNAPSHOT-sxr.jar/!/index.html)
